...
for t = 1:2;
    for e = 1:numel(ecc)
        ...
        % make some notes...
        params.notes = 'multiplying nCones by 2 to verify sqrt(2) in manuscript High TF mac pig';       % notes that should be associated the data file?
        ...
        %
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        dtnt.rf_x = ecc(e);     % in tenths of dva
        ...
        for a = 1:nColors;
            ...
            pstructs{a}.DTNT_fname = [params.saveDir, 'dtnt_batch_', num2str(a)];
