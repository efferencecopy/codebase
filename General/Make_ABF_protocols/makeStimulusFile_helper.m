...
params.name = 'Trains_amps[4_6_8_10]_SR20kHz_TT1250ms_PW500us';  % the name of the output .atf file
...
params.pFreq = [20];      % A vector of frequencies for the pulse train [interleaved variable]
