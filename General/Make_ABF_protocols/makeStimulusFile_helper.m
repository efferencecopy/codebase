...
params.name = 'Trains_amps[4_6_8_10]_10Hz_SR20kHz_TT1250ms_PW500us';  % the name of the output .atf file
...
params.pAmp = [4,6,8,9.8];                % A vector of amplitudes for the pulse height [interleaved variable]
params.pFreq = [10];              % A vector of frequencies for the pulse train [interleaved variable]
params.nPulses = 3;               % The number of pulses in the pulse train. The code will throw a warning if this can not be done in the time aloted

params.pWidth = 500e-6;           % A vector of pulse widths (in seconds)  [interleaved variable]
